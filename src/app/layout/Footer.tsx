...
export default function Footer() {
  ...
  return (
    <footer className="bg-bg-alt border-t border-border py-16 text-xs font-semibold uppercase tracking-wider">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-secondary mt-1 font-normal normal-case text-xs">
              {profile.role}
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10">
            ...
            >
              ...
              <span className="normal-case font-normal">{profile.email}</span>
            </a>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-secondary/60">
          <p className="normal-case font-sans text-xs font-normal">&copy; {new Date().getFullYear()} {profile.brand}. All rights reserved.</p>
